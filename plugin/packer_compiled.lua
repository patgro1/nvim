...
_G.packer_plugins = {
  ...
  ["nightfox.nvim"] = {
    after = { "nvim-web-devicons", "kommentary", "todo-comments.nvim" },
  ...
  ["plenary.nvim"] = {
    after = { "popup.nvim", "gitsigns.nvim", "git-worktree.nvim" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'orgmode.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'nvim-lspinstall'}, { event = "BufRead *" }, _G.packer_plugins)]]
