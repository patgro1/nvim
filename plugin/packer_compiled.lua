...
_G.packer_plugins = {
  ...
  ["material.nvim"] = {
    after = { "nvim-web-devicons", "kommentary", "nvim-ts-rainbow", "todo-comments.nvim" },
  ...
  ["packer.nvim"] = {
    after = { "material.nvim", "nightfox.nvim" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspinstall', 'orgmode.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
