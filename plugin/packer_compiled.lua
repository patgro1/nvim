...
_G.packer_plugins = {
  ...
  ["material.nvim"] = {
    after = { "nvim-web-devicons", "nvim-ts-rainbow", "todo-comments.nvim" },
  ...
  ["plenary.nvim"] = {
    after = { "gitsigns.nvim", "vim-fugitive", "popup.nvim", "git-worktree.nvim" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspinstall', 'orgmode.nvim', 'nvim-colorizer.lua', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
